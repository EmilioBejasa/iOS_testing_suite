...
public final class MockFamilyControlsAuthorizer: FamilyControlsAuthorizing {
    public var status: AuthorizationCenter.AuthorizationStatus
    public var accessResult: Bool

    public init(status: AuthorizationCenter.AuthorizationStatus = .notDetermined, accessResult: Bool = true) {
        self.status = status
